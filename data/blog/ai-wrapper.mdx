---
title: 'Building an AI Wrapper with Zero AI Knowledge: My First Real Dive into LLMs'
date: '2025-04-20'
lastmod: '2025-04-20'
...
i went into OpenAI’s playground.  
found out models like **gpt-4 turbo with vision and image gen aren’t public via API**.  
...
i also realized **Gemini 2.5 exists only in the chat UI**.  
...
- i assumed the 2.5 API was available. it wasn’t
